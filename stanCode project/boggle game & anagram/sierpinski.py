...
def main():
	"""
	TODO: This program is to create sierpinski triangle
	"""
...
def sierpinski_triangle(order, length, upper_left_x, upper_left_y):
	"""
	:param order: the order of the self similar triangle
	:param length: the length of the triangle
	:param upper_left_x: the based point x value of the triangle
	:param upper_left_y: the based point y value of the triangle
	"""
	if order == 0:
		return
	else:
		...
		line_3 = GLine(upper_left_x + length, upper_left_y, upper_left_x + 0.5 * length, upper_left_y + 0.866 * length)
		window.add(line_1)
		window.add(line_2)
		window.add(line_3)
